...
[스타일 쉐어 스위프트 스타일 가이드](https://github.com/StyleShare/swift-style-guide)를 기초로 변형 되었습니다.
...
- Closure 호출시 파라미터 이름을 생략 하지 않습니다.
...
- 프로토콜을 적용할 때에는 extension을 만들어서 관련된 메서드를 모아둡니다. 단, 프로토콜이 변수를 가지고 있는 경우 분리하지 않습니다.
    ...
    **좋은 예**:
    ...
    final class TestInteractor: TestInteractable {

      // MARK: - TestInteractable
...
- Font, Color 등 리소스를 접근 하는 경우 자동 생성 된 extension만 사용 합니다.
